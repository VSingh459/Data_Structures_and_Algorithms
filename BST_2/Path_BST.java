...
public class Path_BST {
	...
	public static ArrayList<Integer> getPath(Node<Integer> root,int x)
	{
		if (root == null)
		{
			return null;
		...
		if (x < root.data)
		{
			ArrayList<Integer> leftOut = getPath(root.left,x);
			if (leftOut != null)
			{
		...
		{
			ArrayList<Integer> rightOut = getPath(root.right,x);
			if (rightOut != null)
			{
	...
	public static void main(String[] args) {
		...
		ArrayList<Integer> p = getPath(root,1);
